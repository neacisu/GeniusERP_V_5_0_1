...
export default function EditUserPage() {
  ...
  // Adăugăm logging pentru a verifica ID-ul și parametrii
  console.log("EditUserPage rendered with ID:", id);
  console.log("EditUserPage params:", params);
  console.log("EditUserPage current URL:", window.location.pathname);

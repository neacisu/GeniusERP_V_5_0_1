...
import { JwtAuthMode } from '../models/auth.enum';
...
// Import JwtPayload type from shared types
import { JwtPayload } from '@shared/types';

/**
 * Extended JWT payload with additional features
 */
...
export type JwtUserData = ExtendedJwtPayload;

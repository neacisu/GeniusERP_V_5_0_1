...
export class TransactionsRouter {
  ...
  private setupRoutes() {
    ...
    this.router.get('/', AuthGuard.requireAuth(), this.getTransactions.bind(this));
    
    // Get transaction by ID
    this.router.get('/:transactionId', AuthGuard.requireAuth(), this.getTransactionById.bind(this));
    
    // Get transactions for an order
    this.router.get('/order/:orderId', AuthGuard.requireAuth(), this.getOrderTransactions.bind(this));
    
    // Create new transaction
    this.router.post('/', AuthGuard.requireAuth(), this.createTransaction.bind(this));
    
    // Update transaction status
    this.router.patch('/:transactionId/status', AuthGuard.requireAuth(), this.updateTransactionStatus.bind(this));
    
    // Record a refund
    this.router.post('/:transactionId/refund', AuthGuard.requireAuth(), this.recordRefund.bind(this));
    
    // Get transaction statistics
    this.router.get('/stats/:period', AuthGuard.requireAuth(), this.getTransactionStatistics.bind(this));
  }

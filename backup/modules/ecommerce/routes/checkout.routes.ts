...
export class CheckoutRouter {
  ...
  private setupRoutes() {
    ...
    this.router.post('/cart/:cartId', AuthGuard.requireRoles(['ecommerce_admin', 'ecommerce_user']), this.processCartCheckout.bind(this));
    
    // Process direct checkout (without cart)
    this.router.post('/direct', AuthGuard.requireRoles(['ecommerce_admin', 'ecommerce_user']), this.processDirectCheckout.bind(this));
  }

...
export class CartRouter {
  ...
  private setupRoutes() {
    ...
    this.router.get('/active', AuthGuard.requireAuth(), this.getActiveCart.bind(this));
    
    // Get cart by ID
    this.router.get('/:cartId', AuthGuard.requireAuth(), this.getCartById.bind(this));
    
    // Add item to cart
    this.router.post('/item', AuthGuard.requireAuth(), this.addCartItem.bind(this));
    
    // Update cart item quantity
    this.router.put('/item/:itemId', AuthGuard.requireAuth(), this.updateCartItem.bind(this));
    
    // Remove item from cart
    this.router.delete('/item/:itemId', AuthGuard.requireAuth(), this.removeCartItem.bind(this));
    
    // Clear cart
    this.router.delete('/:cartId/clear', AuthGuard.requireAuth(), this.clearCart.bind(this));
    
    // Apply discount to cart
    this.router.post('/:cartId/discount', AuthGuard.requireAuth(), this.applyDiscount.bind(this));
  }

 ...
 * POST /api/v1/accounting/note-contabil/generate
 */
router.post(
  '/generate',
  authGuard.requireAuth(),
  authGuard.requireRoles([UserRole.ADMIN, UserRole.ACCOUNTANT]),
  async (req, res) => {
    try {
 ...
 * POST /api/v1/accounting/note-contabil/:id/reverse
 */
router.post(
  '/:id/reverse',
  authGuard.requireAuth(),
 ...
 * GET /api/v1/accounting/note-contabil/:id
 */
router.get(
  '/:id',
  authGuard.requireAuth(),
 ...
 * GET /api/v1/accounting/note-contabil/:id/pdf
 */
router.get(
  '/:id/pdf',
  authGuard.requireAuth(),

...
import { AuthGuard } from '../../../common/middleware/auth-guard'; //Import updated for consistency.  Further updates may be necessary based on the full authentication strategy.
import { z } from 'zod';
...
export function registerAdminControllerRoutes(app: any, userService: UserService) {
   ...
   * @middleware AuthGuard.requireAuth() - Requires authentication
   * @middleware AuthGuard.requireRoles(['admin']) - Requires admin role
   */
  app.post(`${BASE_PATH}/users`, AuthGuard.requireAuth(), AuthGuard.requireRoles(['admin']), async (req: Request, res: Response) => {
    try {
   ...
   * @middleware AuthGuard.requireRoles(['admin']) - Requires admin role
   */
  app.get(`${BASE_PATH}/users`, AuthGuard.requireAuth(), AuthGuard.requireRoles(['admin']), async (req: Request, res: Response) => {
    try {
   ...
   * @middleware AuthGuard.requireRoles(['admin']) - Requires admin role
   */
  app.get(`${BASE_PATH}/users/:id`, AuthGuard.requireAuth(), AuthGuard.requireRoles(['admin']), async (req: Request, res: Response) => {
    try {
   ...
   * @middleware AuthGuard.requireRoles(['admin']) - Requires admin role
   */
  app.patch(`${BASE_PATH}/users/:id`, AuthGuard.requireAuth(), AuthGuard.requireRoles(['admin']), async (req: Request, res: Response) => {
    try {
      const userId = req.params.id;
   ...
   * @middleware AuthGuard.requireRoles(['admin']) - Requires admin role
   */
  app.delete(`${BASE_PATH}/users/:id`, AuthGuard.requireAuth(), AuthGuard.requireRoles(['admin']), async (req: Request, res: Response) => {
    try {
      const userId = req.params.id;
   ...
   * @middleware AuthGuard.requireRoles(['admin']) - Requires admin role
   */
  app.post(`${BASE_PATH}/users/:id/roles`, AuthGuard.requireAuth(), AuthGuard.requireRoles(['admin']), async (req: Request, res: Response) => {
    try {
      const userId = req.params.id;
   ...
   * @middleware AuthGuard.requireRoles(['admin']) - Requires admin role
   */
  app.post(`${BASE_PATH}/users/:id/change-password`, AuthGuard.requireAuth(), AuthGuard.requireRoles(['admin']), async (req: Request, res: Response) => {
    try {
      const userId = req.params.id;

...
export function registerWatcherRoutes(app: Express, watcherService: WatcherService): void {
   ...
   */
  app.get(`${BASE_PATH}/watched-tasks`, AuthGuard.requireAuth(), AuthGuard.requireCompanyAccess(), async (req: Request, res: Response) => {
    try {
   ...
   */
  app.post(`${BASE_PATH}/add-user`, AuthGuard.requireAuth(), AuthGuard.requireCompanyAccess(), async (req: Request, res: Response) => {
    try {
      const companyId = req.user?.companyId || '';
   ...
   */
  app.patch(`${BASE_PATH}/:taskId`, AuthGuard.requireAuth(), AuthGuard.requireCompanyAccess(), async (req: Request, res: Response) => {
    try {
   ...
   */
  app.get(`${BASE_PATH}/:taskId/is-watching`, AuthGuard.requireAuth(), AuthGuard.requireCompanyAccess(), async (req: Request, res: Response) => {
    try {
      const { taskId } = req.params;
      const userId = req.user?.id || '';
      const companyId = req.user?.companyId || '';
   ...
   */
  app.delete(`${BASE_PATH}/:taskId`, AuthGuard.requireAuth(), AuthGuard.requireCompanyAccess(), async (req: Request, res: Response) => {
    try {
      const { taskId } = req.params;
      const userId = req.user?.id || '';
      const companyId = req.user?.companyId || '';
   ...
   */
  app.delete(`${BASE_PATH}/:taskId/users/:userId`, AuthGuard.requireAuth(), AuthGuard.requireCompanyAccess(), async (req: Request, res: Response) => {
    try {

...
export class ContactsRouter {
  ...
  private setupRoutes() {
    ...
    this.router.get('/', requireAuth(), this.getContacts.bind(this));
    
    // Get a specific contact
    this.router.get('/:contactId', requireAuth(), this.getContact.bind(this));
    
    // Create a new contact
    this.router.post('/', requireAuth(), this.createContact.bind(this));
    
    // Update a contact
    this.router.patch('/:contactId', requireAuth(), this.updateContact.bind(this));
    
    // Delete a contact
    this.router.delete('/:contactId', requireAuth(), this.deleteContact.bind(this));
    
    // Find contacts by identifiers (email, phone, etc.)
    this.router.post('/find', requireAuth(), this.findContacts.bind(this));
  }

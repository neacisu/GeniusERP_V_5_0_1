...
import { Services, logAction } from './server/common/services';
...
async function testAuditService() {
  ...
  try {
    ...
    // We've successfully logged multiple types of audit entries
    console.log('\n🎉 All audit service logging tests completed successfully!');
    return { success: true };

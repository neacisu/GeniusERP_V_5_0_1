 ...
 * 
 * Manage invoice templates for customized invoice generation.
 */
...
const TemplatesPage: React.FC = () => {
  ...
  const tabItems: TabItem[] = [
    { id: "all", label: "Toate șabloanele" },
    { id: "active", label: "Active" },
    { id: "draft", label: "Schițe" },
    { id: "archived", label: "Arhivate" }
  ];

  const handleCreateTemplate = () => {
    // Navigate to template creation page (to be implemented)
  };
  ...
  return (
    <div className="space-y-6">
      <PageHeader 
        ...
        description="Gestionează șabloanele pentru facturile personalizate"
        onAddNew={handleCreateTemplate}
        addNewLabel="Șablon nou"
      />

...
// Tipuri de surse pentru rezervările de stoc
export const reservationSourceEnum = {
  enumValues: ['online_order', 'sales_order', 'warehouse_transfer', 'other'] as const
};

// Adăugăm tipul pentru rezervări de stoc
export type StockReservation = {
  id: string;
  stockId: string;
  reservationQuantity: number;
  sourceType: typeof reservationSourceEnum.enumValues[number]; // Tipul sursei de rezervare
  sourceId?: string | null; // ID-ul documentului sursă (comandă, transfer etc.)
  notes?: string | null;
...
// Schema pentru validarea rezervărilor de stoc
export const insertStockReservationSchema = z.object({
  stockId: z.string().uuid(),
  reservationQuantity: z.number().positive(),
  sourceType: z.enum(reservationSourceEnum.enumValues),
  sourceId: z.string().uuid().optional().nullable(),
  notes: z.string().optional().nullable(),
  reservationDate: z.date().default(() => new Date()),
  expiryDate: z.date().optional().nullable(),
  isActive: z.boolean().default(true),
...
export const createStockReservationSchema = insertStockReservationSchema;
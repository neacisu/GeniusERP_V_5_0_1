...
export class POSRouter {
  ...
  private setupRoutes() {
    ...
    this.router.post('/connect', AuthGuard.protect(JwtAuthMode.REQUIRED), AuthGuard.roleGuard(['ecommerce_admin', 'ecommerce_manager']), this.connectPosSystem.bind(this));
    
    // Check POS connection status
    this.router.get('/status/:posSystem', AuthGuard.protect(JwtAuthMode.REQUIRED), AuthGuard.roleGuard(['ecommerce_admin', 'ecommerce_manager', 'ecommerce_user']), this.checkPosConnection.bind(this));
    
    // Import orders from POS
    this.router.post('/import-orders', AuthGuard.protect(JwtAuthMode.REQUIRED), AuthGuard.roleGuard(['ecommerce_admin', 'ecommerce_manager']), this.importOrders.bind(this));
    
    // Export products to POS
    this.router.post('/export-products', AuthGuard.protect(JwtAuthMode.REQUIRED), AuthGuard.roleGuard(['ecommerce_admin', 'ecommerce_manager']), this.exportProducts.bind(this));
    
    // Sync inventory with POS
    this.router.post('/sync-inventory', AuthGuard.protect(JwtAuthMode.REQUIRED), AuthGuard.roleGuard(['ecommerce_admin', 'ecommerce_manager']), this.syncInventory.bind(this));
  }

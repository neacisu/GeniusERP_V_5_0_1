 ...
 * Checkout Router
 * 
 * This router handles routes related to the checkout process.
 */
...
export class CheckoutRouter {
  ...
  constructor(checkoutService: CheckoutService) {
    ...
    this.setupRoutes();
    logger.info('CheckoutRouter initialized');
  }
  ...
  private setupRoutes() {
    ...
    this.router.post('/cart/:cartId', AuthGuard.protect(JwtAuthMode.REQUIRED), AuthGuard.roleGuard(['ecommerce_admin', 'ecommerce_user']), this.processCartCheckout.bind(this));
    
    // Process direct checkout (without cart)
    this.router.post('/direct', AuthGuard.protect(JwtAuthMode.REQUIRED), AuthGuard.roleGuard(['ecommerce_admin', 'ecommerce_user']), this.processDirectCheckout.bind(this));
  }

...
// Create a logger
const logger = createModuleLogger('ShopifyRouter');
...
export class ShopifyRouter {
  ...
  private setupRoutes() {
    ...
    this.router.get('/status', AuthGuard.protect(JwtAuthMode.REQUIRED), this.getIntegrationStatus.bind(this));
    
    // Save Shopify credentials
    this.router.post('/credentials', AuthGuard.protect(JwtAuthMode.REQUIRED), this.saveCredentials.bind(this));
    
    // Verify Shopify credentials
    this.router.post('/verify-credentials', AuthGuard.protect(JwtAuthMode.REQUIRED), this.verifyCredentials.bind(this));
    
    // Enable/disable integration
    this.router.put('/enabled', AuthGuard.protect(JwtAuthMode.REQUIRED), this.setIntegrationEnabled.bind(this));
    
    // Sync products from Shopify
    this.router.post('/sync/products', AuthGuard.protect(JwtAuthMode.REQUIRED), this.syncProducts.bind(this));
    
    // Import orders from Shopify
    this.router.post('/import/orders', AuthGuard.protect(JwtAuthMode.REQUIRED), this.importOrders.bind(this));

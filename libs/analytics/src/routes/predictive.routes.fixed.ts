...
/**
 * Setup Predictive Routes
 * 
 * @returns Express router with predictive routes
 */
export function setupPredictiveRoutes() {
  return router;
}
 ...
 */
export function setupPredictiveAnalyticsRoutes() {
  return router;
}

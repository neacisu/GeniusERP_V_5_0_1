...
export class ModuleSettingsService {
  ...
  constructor(drizzleService?: DrizzleService) {
    this.logger = createModuleLogger('ModuleSettingsService');
   ...
   */
  public static getInstance(drizzleService?: DrizzleService): ModuleSettingsService {
    if (!ModuleSettingsService.instance) {
      ModuleSettingsService.instance = new ModuleSettingsService(drizzleService);
    }
